...
export default function RoundedCarousel() {
  ...
  useGSAP(() => {
    ...
    gsap.set(items, {
      motionPath: {
        ...
        align: circlePath,
        alignOrigin: [0.5, 0.5],
        // Changed offset to 0.75 so index 0 starts at the exact top (12 o'clock position)
  ...
  return (
    <div ref={containerRef} className="relative max-w-[1000px] mx-auto min-h-[1200px] flex flex-col items-center justify-center overflow-hidden">
